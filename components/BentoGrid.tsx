...
const skillTags = [
  ...
  'Docker', 'GraphQL', 'PostgreSQL', 'Tailwind CSS'
];
        ...
        <div className="project-showcase">
          <div className="project-preview">
            ...
            <div className="project-overlay">
              <div className="project-status">{featuredProjects[activeProject].status}</div>
            </div>
          </div>
          <div className="project-info">
            <h4 className="project-title">{featuredProjects[activeProject].title}</h4>
        ...
        <div className="status-info">
          ...
          <div className="location">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M21 10C21 17L12 23L3 10C3 6.13 7.03 3 12 3S21 6.13 21 10Z"/>
